...
/*   Updated: 2024/09/28 11:48:07 by artclave         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	HttpRequest::getPostFileFd() const { return postFileFd; }
std::string	&HttpRequest::getPostFileContent() { return postFileContent;}
...
void HttpRequest::setPostFileContent(const std::string &content) {postFileContent = content; }
void HttpRequest::setPostFileFd(int fd) {postFileFd = fd;}
